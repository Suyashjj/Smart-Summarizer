...
const steps : Step[] = [
  ...
  },
  {
    ...
    label : "AI Analysis",
    description : "Our AI model analyzes the document and extracts the key information"
  },
  {
    icon : <FileOutput size ={64} strokeWidth={1.5}/>,
    label : "Get Summary",
    description : "Receive a concise summary of the document in a matter of seconds"
  }
]
        ...
        <section className="relative overflow-hidden bg-gray-50">
            ...
            <div className="text-center mb-16">
                ...
                <h3 className="font-bold text-3xl max-w-2xl mx-auto">
                    Transfrom Your PDF into an easy-to-digest summary in three simple steps
                </h3>
            </div>
